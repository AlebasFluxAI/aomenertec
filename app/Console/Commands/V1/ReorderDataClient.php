...
class ReorderDataClient extends Command
{
    ...
    public function jsonEdit(MicrocontrollerData $data)
    {
        ...
        $data->accumulated_real_consumption = $json['import_wh'];
        $data->interval_real_consumption = $json['kwh_interval'];
        $data->accumulated_reactive_consumption = $json['import_VArh'];
        $data->interval_reactive_consumption = $json['varh_interval'];
        ...
        $data->interval_reactive_capacitive_consumption = $json['varCh_interval'];
        $data->interval_reactive_inductive_consumption = $json['varLh_interval'];
        $data->raw_json = $json;
        $data->saveQuietly();
