...
class AddAdmin extends Component
{
    ...
    protected $messages = [
        ...
        'model.latitude.required' => 'La latitud es obligatoria. Seleccione una ubicación en el mapa.',
        'model.longitude.required' => 'La longitud es obligatoria. Seleccione una ubicación en el mapa.',
