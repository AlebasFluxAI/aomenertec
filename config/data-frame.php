...
return [
    ...
    'alert_config_frame' => [
        ...
        ['flag_id' => 51, 'limit' => 'max_alert', 'variable_name' => 'max_var', 'start' => 624, 'lenght' => 8, 'type' => 'f'],
        ['flag_id' => 51, 'limit' => 'min_alert', 'variable_name' => 'min_var', 'start' => 632, 'lenght' => 8, 'type' => 'f'],

        ['flag_id' => 52, 'limit' => 'max_alert', 'variable_name' => 'kwh_month', 'start' => 640, 'lenght' => 8, 'type' => 'f'],
        ['flag_id' => 53, 'limit' => 'max_alert', 'variable_name' => 'kvarlh_month', 'start' => 648, 'lenght' => 8, 'type' => 'f'],
        ['flag_id' => 54, 'limit' => 'max_alert', 'variable_name' => 'kvarch_month', 'start' => 656, 'lenght' => 8, 'type' => 'f'],
        ['flag_id' => 55, 'limit' => 'max_alert', 'variable_name' => 'kwh_hour', 'start' => 664, 'lenght' => 8, 'type' => 'f'],
        ['flag_id' => 56, 'limit' => 'max_alert', 'variable_name' => 'kvarlh_hour', 'start' => 672, 'lenght' => 8, 'type' => 'f'],
        ['flag_id' => 57, 'limit' => 'max_alert', 'variable_name' => 'kvarch_hour', 'start' => 680, 'lenght' => 8, 'type' => 'f'],
        ['flag_id' => 58, 'limit' => 'max_alert', 'variable_name' => 'kvarlh_penalizable', 'start' => 688, 'lenght' => 8, 'type' => 'f'],
        ['flag_id' => 59, 'limit' => 'max_alert', 'variable_name' => 'kvarch/kwh', 'start' => 696, 'lenght' => 8, 'type' => 'f'],
    ...
    'flags_frame' => [
        ...
        ['id' => 41,'flag_name'=> 'flagTHDVolt1', 'description' => '',  'variable_name'=> 'ph1_volt_thd',      'placeholder'=>'Distorsion armonica total voltaje fase 1', 'bit' => 54, 'index' => 9,  'variable_id' => 40],
        ['id' => 42,'flag_name'=> 'flagTHDVolt2', 'description' => '',  'variable_name'=> 'ph2_volt_thd',      'placeholder'=>'Distorsion armonica total voltaje fase 2', 'bit' => 55, 'index' => 8,  'variable_id' => 41],
        ['id' => 43,'flag_name'=> 'flagTHDVolt3', 'description' => '',  'variable_name'=> 'ph3_volt_thd',      'placeholder'=>'Distorsion armonica total voltaje fase 3', 'bit' => 56, 'index' => 7,  'variable_id' => 42],
        ['id' => 44,'flag_name'=> 'flagTHDCurr1', 'description' => '',  'variable_name'=> 'ph1_current_thd',   'placeholder'=>'Distorsion armonica total corriente fase 1', 'bit' => 57, 'index' => 6,  'variable_id' => 43],
        ['id' => 45,'flag_name'=> 'flagTHDCurr2', 'description' => '',  'variable_name'=> 'ph2_current_thd',   'placeholder'=>'Distorsion armonica total corriente fase 2', 'bit' => 58, 'index' => 5,  'variable_id' => 44],
        ['id' => 46,'flag_name'=> 'flagTHDCurr3', 'description' => '',  'variable_name'=> 'ph3_current_thd',   'placeholder'=>'Distorsion armonica total corriente fase 3', 'bit' => 59, 'index' => 4,  'variable_id' => 45],
        ['id' => 47,'flag_name'=> 'flagTHDVolt12', 'description' => '', 'variable_name'=> 'ph1_ph2_volt_thd',  'placeholder'=>'Distorsion armonica total voltaje entre fase 1 y 2', 'bit' => 60, 'index' => 3,  'variable_id' => 46],
        ...
        ['id' => 51,'flag_name'=> 'flagvar', 'description' => '',     'variable_name'=> 'var',          'placeholder'=>'Voltio-amperios reactivo', 'bit' => 18, 'index' => 45, 'variable_id' => 31],

        ['id' => 52,'flag_name'=> 'kwh_month', 'description' => '', 'variable_name'=>'kwh_month','placeholder'=> 'kWh/Mes', 'bit' => 19, 'index' => 44, 'variable_id' => 61],
        ['id' => 53,'flag_name'=> 'kvarlh_month', 'description' => '', 'variable_name'=>'kvarlh_month', 'placeholder'=> 'kVARLh/Mes', 'bit' => 20, 'index' => 43, 'variable_id' => 61],
        ['id' => 54,'flag_name'=> 'kvarch_month', 'description' => '', 'variable_name'=>'kvarch_month', 'placeholder'=> 'kVARCh/Mes', 'bit' => 21, 'index' => 42, 'variable_id' => 61],
        ['id' => 55,'flag_name'=> 'kwh_hour', 'description' => '', 'variable_name'=>'kwh_hour', 'placeholder'=> 'kWh/Hora', 'bit' => 22, 'index' => 41, 'variable_id' => 61],
        ['id' => 56,'flag_name'=> 'kvarlh_hour', 'description' => '', 'variable_name'=>'kvarlh_hour', 'placeholder'=> 'kVARLh/Hora', 'bit' => 23, 'index' => 40, 'variable_id' => 61],
        ['id' => 57,'flag_name'=> 'kvarch_hour', 'description' => '', 'variable_name'=>'kvarch_hour', 'placeholder'=> 'kVARCh/Hora', 'bit' => 24, 'index' => 39, 'variable_id' => 61],
        ['id' => 58,'flag_name'=> 'kvarlh_penalizable', 'description' => '', 'variable_name'=>'kvarlh_penalizable', 'placeholder'=> 'Porcentaje horario kVARLh/kWh', 'bit' => 25, 'index' => 38, 'variable_id' => 61],
        ['id' => 59,'flag_name'=> 'kvarch/kwh', 'description' => '', 'variable_name'=>'kvarch/kwh', 'placeholder'=> 'Porcentaje horario kVARCh/kWh', 'bit' => 26, 'index' => 37, 'variable_id' => 61],
