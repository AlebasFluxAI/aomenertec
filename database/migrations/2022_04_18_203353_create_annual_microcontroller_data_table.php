...
class CreateAnnualMicrocontrollerDataTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('annual_microcontroller_data', function (Blueprint $table) {
            ...
            $table->dropColumn('active_consumption');
            $table->dropColumn('penalizable_reactive_capacitive_consumption');
            $table->dropColumn('penalizable_reactive_inductive_consumption');
