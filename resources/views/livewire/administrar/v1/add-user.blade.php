                    ...
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <div class="container-fluid">
                            ...
                            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                                <ul class="navbar-nav">
                                    <li class="nav-item">
                                        <a href="{{ route('administrar.edituser') }}">
    ...
    <section class="login">
        <div class="container">
            <div class="section-title">
                <h2 class="text-center p3"><b><span class="naranja">Agregar </span> <span class="azul">Usuario</span></b></h2>
            </div>
                                ...
                                <div class="form-group mb-2 col-md-12 col-sm-12">
                                    <div class="input-group">
                                        ...
                                        <input wire:model="network_operator"
                                               wire:keydown.enter="assignNetworkOperatorFirst()" type="text" class="form-control" id="network_operator" autocomplete="off" placeholder="Identificación" required >
