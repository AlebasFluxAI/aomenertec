                            ...
                            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item dropdown">
                                        <button class="nav-item "  id="DropdownMenuClientes" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                            Clientes ▼
                                        </button>
                                    ...
                                    <li class="nav-item dropdown">
                                        <button class="nav-item "  id="DropdownMenuPrecio" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                            Precios ▼
                                        </button>
                                    ...
                                    <li class="nav-item">
                                        <a title="Cerrar sesion" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                            <button>
    ...
    <section class="login">
        <div class="container">
            <div class="section-title">
                <h2 class="text-center p3"><b><span class="naranja">Editar </span> <span class="azul">Usuario</span></b></h2>
            </div>
                            ...
                            <div class="form-group mb-2 col-md-12 col-sm-12">
                                <div class="input-group">
                                    ...
                                    <input wire:model="user"
                                           wire:keydown.enter="asisignUserFirst()" type="text" class="form-control" id="user" autocomplete="off" placeholder="Identificacion" required >
                            ...
                            @if($pickedU)
                                ...
                                <div class="form-group mb-2 col-md-4 col-sm-12">
                                    <div class="input-group">
                                        ...
                                        <input wire:model="identification" type="number" class="form-control" autocomplete="off" placeholder="Identificacion" required >
                                    </div>
                                ...
                                <div class="form-group mb-2 col-md-8 col-sm-12">
                                    <input wire:model="name" id="name" class="form-control typeahead" autocomplete="off" name="name" type="text" placeholder="Nombre" required/>
                                    @error('name')
                                    <div  class="error-container">
                                        <small class="form-text text-danger">{{$message}}</small>
                                    </div>
                                ...
                                <div class="form-group mb-2 col-md-4 col-sm-12">
                                    <input wire:model="phone" class="form-control" id ="phone" name="phone" type="number" autocomplete="off" placeholder="Celular" value="" required />
                                    @error('phone')
                                        <div  class="error-container">
                                            <small class="form-text text-danger">{{$message}}</small>
                                        </div>
                                ...
                                <div class="form-group mb-2 col-md-5 col-sm-12">
                                    <input wire:model="email"  type="email" class="form-control"  name="email" id="email" autocomplete="off" value="" placeholder="Correo electronico" required/>
                                    @error('email')
                                        <div  class="error-container">
                                            <small class="form-text text-danger">{{$message}}</small>
                                        </div>
                                    ...
                                    <div class="form-group mb-2 col-md-12 col-sm-12">
                                        <div class="input-group">
                                            ...
                                            <input wire:model="network_operator"
                                                   wire:keydown.enter="assignNetworkOperatorFirst()" type="text" class="form-control" id="network_operator" autocomplete="off" placeholder="Identificacion" required >
                                            <div class="input-group-append">
                                            <span class="input-group-text" >
                                                @if($picked)
                                                    <span class="badge badge-success">
                                                ...
                                                @if(!$picked)
                                                    <ul class="dropdown-menu list-search">
                                                        ...
                                                        @foreach($network_operators as $usuario)
                                                            <li  class="dropdown-item">
                                                                <a wire:click="assignNetworkOperator('{{ $usuario }}')" type="button" >
                                                                    {{ $usuario->name }}
                                                                </a>
                                                            </li>
                                                        @endforeach
                    ...
                    <div class=" modal-body">
                        <div class="row section-title">
                            <div class="col-12">
                                ...
                                <h6 class="text-center"><b><span class="naranja">Se eliminaran todos los registros relacionados</span></b></h6>
                            </div>
                        </div>
                        <div>
                            <div class="row content py-1">
                                <div class="text-center contenedor-grande justify-content-between">
                                    <button wire:click="eliminar()" class="button py-2 px-2 mx-4" onclick="document.getElementById('confirmar').close();" type="button"><b>Aceptar</b></button>
                                    <button onclick="document.getElementById('confirmar').close();" class="b-danger button mx-4 py-2 px-2" type="button"><b>Cancelar</b></button>
                                </div>
                            </div>
                        </div>
                    </div>
