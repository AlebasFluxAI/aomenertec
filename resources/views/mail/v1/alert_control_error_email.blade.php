        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
            ...
            <tr>
                <td style="direction:ltr;font-size:0px;padding:10px 0;text-align:center;">
                    ...
                    <!--[if mso | IE]></td>
                    <td class="" style="vertical-align:top;width:396px;"><![endif]-->
                                        ...
                                        <tr>
                                            <td align="left"
                                                ...
                                                <div
                                                    ...
                                                    Nueva alerta de control generada
                                                </div>
                                            </td>
                                        </tr>
                                        </tbody>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                                    ...
                                                    <tr>
                                                        <td style="width:192px;">
                                                            <img alt="tickets" height="auto"
                                                                 src="https://cdn-icons-png.flaticon.com/512/4329/4329979.png"
                                                                 style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;"
                                                                 width="192">
                                                        </td>
                                                    </tr>
                                            ...
                                            <td align="center"
                                                ...
                                                <div
                                                    ...
                                                    <p style="font-weight: bold">Una variable fuera de rango con acción
                                                        de control.</p>
                                                    <p style="font-weight: bold">Variable: {{$variable_name}}</p>
                                                    <p style="font-weight: bold">Valor: {{$variable_value}}</p>
                                                    <p style="font-weight: bold">Hora: {{$variable_time}}</p>
                                                    <p style="font-weight: bold">Salidas
                                                        relacionadas: {{$variable_outputs}}</p>
                                                    <br>
                                                    <p>
                                                        <b>Nota:</b> Fallo la comunicación, Salidas no accionadas
                                                        correctamente 🔴</p>
                                                    <br>
                                                    <p>Para información mas detallada visite el siguiente link
                                                        {{$detail_link}}</p>
                                                </div>
                                            </td>
                                        </tr>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style
                                        ...
                                        <tr>
                                            <td align="center" style="font-size:0px;padding:0px;word-break:break-word;">
                                                <p style="border-top:solid 3px #c9c9c9;font-size:1px;margin:0px auto;width:100%;">
                                                </p>
                                                <!--[if mso | IE]><table align="center" border="0" cellpadding="0" cellspacing="0" style="border-top:solid 3px #c9c9c9;font-size:1px;margin:0px auto;width:600px;" role="presentation" width="600px" ><tr><td style="height:0;line-height:0;"> &nbsp;
                </td></tr></table><![endif]-->
                                            </td>
                                        </tr>
