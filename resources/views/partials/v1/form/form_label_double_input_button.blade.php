<div class="form-group mx-0 mb-{{$mb??2}} mt-{{$mt??0}} col-md-{{$col_width??6}} col-sm-12 ">
    <div class="input-group">
        ...
        <input wire:model.defer="{{ $model_second_input }}" type="{{ $type_second_input }}" class="form-control" placeholder="{{ $placeholder_second_input }}" @if($disabled??false) disabled @endif>
