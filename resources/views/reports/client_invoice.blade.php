...
<table class="header-container">
    <tr class="flex-row" >
        <td class="flex-item" rowspan="3" style="padding-top: 4px; padding-bottom: 4px"> <img src={{$admin->icon->url}} alt="Logo" class="logo"></td>
        <td class="flex-item" rowspan="3" style="padding-top: 4px; padding-bottom: 4px">{{$network_operator->name. ' '. $network_operator->last_name}}<br>{{$network_operator->identification_type.': '.$network_operator->identification}}<br>www.enerteclatam.com</td>
        <td class="flex-item" style="background: #ffdf7e; border-bottom-left-radius: 15px; padding-top: 4px; padding-bottom: 4px" ><strong>No. de factura:</strong></td>
        <td class="flex-item" style="background: #fff; border-top-right-radius: 15px; text-align: right; padding-top: 4px; padding-bottom: 4px">{{ $other_data['numero_factura'] }}</td>
    </tr>
    <tr class="flex-row">
        <td class="flex-item" style="padding-top: 4px; padding-bottom: 4px; background: #ffdf7e; border-bottom-left-radius: 15px;"><strong>Total a pagar:</strong></td>
        <td class="flex-item" style="padding-top: 4px; padding-bottom: 4px; background: #fff; border-top-right-radius: 15px; text-align: right;">{{'$'.number_format($value->total, 2, ',', '.')}}</td>
    </tr>
    <tr class="flex-row">
        <td class="flex-item" style="padding-top: 4px; padding-bottom: 4px; background: #ffdf7e; border-bottom-left-radius: 15px;"><strong>Pago oportuno:</strong></td>
        <td class="flex-item" style="padding-top: 4px; padding-bottom: 4px; background: #fff; border-top-right-radius: 15px; text-align: right; ">{{ $other_data['pago_oportuno'] }}</td>
    </tr>
</table>
...
<table class="large-container" style="margin-top: 110px;">
    ...
    <tr class="flex-row">
        ...
        <td class="flex-item" style="padding:1px;" colspan="2">{{$client->address->city.', '.$client->address->state }}</td>
    </tr>
    <tr class="flex-row">
        <td class="flex-item" style="padding:1px; text-align: right;"><strong>{{$client->identification_type}}:</strong></td>
    ...
    <tr class="flex-row">
        ...
        <td class="flex-item" style="padding:1px; text-align: left;" colspan="2">{{($client->stratum->name == 'Comercial' || $client->stratum->name == 'Industrial')?$client->stratum->name:'Domicialiario' }}</td>
    ...
    <tr class="flex-row">
        ...
        <td class="flex-item" style="padding:1px; text-align: left;" colspan="5">hdsgailgDUGSDUIgdugdAOBDKÑBFOPIFD54G8564F56SGH456HG454H4DH</td>
    </tr>
        ...
        <td>
            <table class="middle-container" style="margin-top: 5px; margin-right: 5px; ">
                ...
                <tr class="flex-row">
                    ...
                    <td class="flex-item" style="padding:5px; text-align: right" >{{ $other_data['numero_factura'] }}</td>
                </tr>
                <tr class="flex-row">
                    <td class="flex-item" style="padding:5px; text-align: left;"><strong>Periodo facturado</strong></td>
                    <td class="flex-item" style="padding:5px; text-align: right" >{{ $other_data['periodo_facturado'] }}</td>
                </tr>
                <tr class="flex-row">
                    <td class="flex-item" style="padding:5px; text-align: left;"><strong>Dias facturados</strong></td>
                    <td class="flex-item" style="padding:5px; text-align: right" >{{ $other_data['dias_facturados'] }}</td>
                </tr>
            </table>
            <table class="middle-container" style="margin-top: 5px; margin-right: 5px;">
                <tr class="flex-row">
                ...
                <tr class="flex-row">
                    ...
                    <td class="flex-item" style="padding:2px; text-align: center;" >{{number_format($other_data['last_month'], 2, ',', '.')}}</td>
                    <td class="flex-item" style="padding:2px; text-align: center" >{{number_format($other_data['promedio'], 2, ',', '.')}}</td>
                </tr>
                <tr class="flex-row">
            ...
            <table class="middle-container" style="margin-top: 13px; margin-right: 5px; font-size: 10px ">
                ...
                <tr class="flex-row">
                    ...
                    <td class="flex-item" style="padding:1px; text-align: center" >{{number_format($monthly_data->interval_real_consumption, 2, ',', '.')}}</td>
                </tr>
                <tr class="flex-row">
                    ...
                    <td class="flex-item" style="padding:1px; text-align: center" >{{number_format($monthly_data->interval_reactive_inductive_consumption, 2, ',', '.')}}</td>
                </tr>
                <tr class="flex-row">
                    ...
                    <td class="flex-item" style="padding:1px; text-align: center" >{{number_format($monthly_data->interval_reactive_capacitive_consumption, 2, ',', '.')}}</td>
                </tr>
                <tr class="flex-row">
                    <td class="flex-item" style="padding:1px; text-align: left;">Reactiva inductiva facturada </td>
                    <td class="flex-item" style="padding:1px; text-align: center; " >kVArLh</td>
                    <td class="flex-item" style="padding:1px; text-align: center" >{{number_format($monthly_data->penalizable_reactive_inductive_consumption, 2, ',', '.')}}</td>
                </tr>
                <tr class="flex-row">
        ...
        <td>
            ...
            <table class="middle-container" style="margin-top: 5px; margin-left: 5px; ">
                ...
                <tr class="flex-row" style="background: #B6B7B7;">
                    ...
                    <td class="flex-item" style="padding:3px; text-align: right" >{{'$'.number_format($fees->generation, 2, ',', '.')}}</td>
                </tr>
                <tr class="flex-row" style="background: #F3F3F3;">
                    <td class="flex-item" style="padding:3px; text-align: left;"><strong>Transmisión (T)</strong></td>
                    <td class="flex-item" style="padding:3px; text-align: right" >{{'$'.number_format($fees->transmission, 2, ',', '.')}}</td>
                </tr>
                <tr class="flex-row" style="background: #B6B7B7;">
                    <td class="flex-item" style="padding:3px; text-align: left;"><strong>Distribucción (D)</strong></td>
                    <td class="flex-item" style="padding:3px; text-align: right" >{{'$'.number_format($fees->distribution, 2, ',', '.')}}</td>
                </tr>
                <tr class="flex-row" style="background: #F3F3F3;">
                    <td class="flex-item" style="padding:3px; text-align: left;"><strong>Comercialización (Cv)</strong></td>
                    <td class="flex-item" style="padding:3px; text-align: right" >{{'$'.number_format($fees->commercialization, 2, ',', '.')}}</td>
                </tr>
                <tr class="flex-row" style="background: #B6B7B7;">
                    <td class="flex-item" style="padding:3px; text-align: left;"><strong>Pérdidas (P)</strong></td>
                    <td class="flex-item" style="padding:3px; text-align: right" >{{'$'.number_format($fees->lost, 2, ',', '.')}}</td>
                </tr>
                <tr class="flex-row" style="background: #F3F3F3;">
                    <td class="flex-item" style="padding:3px; text-align: left;"><strong>Restricciones (R)</strong></td>
                    <td class="flex-item" style="padding:3px; text-align: right" >{{'$'.number_format($fees->restriction, 2, ',', '.')}}</td>
                </tr>
                <tr class="flex-row" style="background: #009599;">
...
<table class="table-container">
    <tr>
        <table class="middle-container" style="margin-top: 5px; margin-left: 5px; ">
            <tr class="flex-row">
                <td class="flex-item" style="padding: 10px; margin: 0; background: #009599; border-top-left-radius: 10px;border-top-right-radius: 10px; text-align: center;" colspan="2"><strong>Para pagos en banco</strong></td>
            </tr>
            <tr class="flex-row">
                <td class="flex-item" style="padding: 6px; margin: 0; text-align: center;" colspan="2"><img class="bar_code" src="data:image/png;base64,{{ $bar_code }}" alt="Código QR"></td>
            </tr>
        </table>
        <td>
            <table class="middle-container" style="margin-top: 5px; margin-left: 5px; ">
                <tr class="flex-row">
                    <td class="flex-item" style="padding: 10px; margin: 0; background: #009599; border-top-left-radius: 10px;border-top-right-radius: 10px; text-align: center;" colspan="2"><strong>Para pagos en linea</strong></td>
                </tr>
                <tr class="flex-row">
                    <td class="flex-item" style="padding: 6px; margin: 0; text-align: center;" colspan="2"><img class="qr_code" src="data:image/png;base64,{{ $qr_code }}" alt="Código QR"></td>
                </tr>
            </table>
